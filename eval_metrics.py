...
def main() -> int:
    ...
    parser.add_argument("--policy", choices=["ddpm", "ddim", "flow"], required=True, help="Which sampler/eval scripts to use.")
    ...
    append_result_csv(
        csv_path,
        {
            ...
            "flow_hl_steps": flow_hl_steps if args.policy == "flow" else "",
            "flow_ll_steps": flow_ll_steps if args.policy == "flow" else "",
            "flow_hl_solver": flow_hl_solver if args.policy == "flow" else "",
            "flow_ll_solver": flow_ll_solver if args.policy == "flow" else "",
            "flow_hl_clip_mode": flow_hl_clip_mode if args.policy == "flow" else "",
            ...
            "ddim_steps": args.ddim_steps if args.policy == "ddim" else "",
            "ddim_hl_steps": ddim_hl_steps if args.policy == "ddim" else "",
            "ddim_ll_steps": ddim_ll_steps if args.policy == "ddim" else "",
            "ddim_eta": args.ddim_eta if args.policy == "ddim" else "",
            "ddim_train_timesteps": args.ddim_train_timesteps if args.policy == "ddim" else "",
        },
    )
